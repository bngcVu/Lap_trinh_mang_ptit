...
public class KhoangCachNhoNhat {
    public static void main(String[] args) throws IOException {
        ...
        String code = "B22DCCN634;TbzkNfL3";
...
/*
 * [Mã câu hỏi (qCode): TbzkNfL3]. Một chương trình server hỗ trợ kết nối qua
 ...
 * trên sử dụng luồng byte dữ liệu (InputStream/OutputStream) để trao đổi thông
 * tin theo thứ tự:
 ...
 * nhau bởi ký tự ","
 * Ex: 1,3,9,19,33,20
 * c. Thực hiện tìm giá trị khoảng cách nhỏ nhất của các phần tử nằm trong chuỗi
 * và hai giá trị lớn nhất tạo nên khoảng cách đó. Gửi lên server chuỗi gồm
