...
public class SapXepChuoi {
    public static void main(String[] args) throws IOException {
        ...
        String code = "B22DCCN634;CZMrJdmx";
        bw.write(code);
        bw.newLine();
        bw.flush();
...
/*
 * [Mã câu hỏi (qCode): CZMrJdmx]. Một chương trình server cho phép kết nối qua
 ...
 * thông tin theo kịch bản sau:
 * a. Gửi một chuỗi gồm mã sinh viên và mã câu hỏi với định dạng
 * "studentCode;qCode". Ví dụ: "B15DCCN999;X1107ABC".
 * b. Nhận từ server một chuỗi ngẫu nhiên chứa nhiều từ, các từ phân tách bởi
 * khoảng trắng.
