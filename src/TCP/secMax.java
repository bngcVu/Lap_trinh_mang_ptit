...
/*
 * [Mã câu hỏi (qCode): 0lhEivaG]. Một chương trình server cho phép kết nối qua
 * giao thức TCP tại cổng 2206 (thời gian giao tiếp tối đa cho mỗi yêu cầu là
 * 5s). Yêu cầu là xây dựng một chương trình client tương tác tới server ở trên
 * sử dụng các luồng byte (InputStream/OutputStream) để trao đổi thông tin theo
 * thứ tự:
