 ...
 * [Mã câu hỏi (qCode): 78CCQ6xD]. Một chương trình server cho phép giao tiếp
 ...
 * 
 * c. Tính và gửi về server danh sách n số nguyên tố đầu tiên theo định dạng
 * "requestId;p1,p2,...,pk", trong đó p1,p2,...,pk là các số nguyên tố.
 * 
